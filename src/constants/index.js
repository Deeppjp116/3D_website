import {ecommecrce,
  ...
  const projects = [
    {
      name: " full E-commrece website",
      description:
        "Web-based platform that allows users to search, order,best UI exprinace.this is clone of amazon ,flipcard same athor platforms.",
      tags: [
        {
          name: "react",
